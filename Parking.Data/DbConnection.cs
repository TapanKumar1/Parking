			...
			protected override void Seed(DbConnection dbHelper)
			{
				var refDataTypes = new List<RefDataType>
				{
					new RefDataType
					{
						...
						DaysAllowed = DaysAllowed.Monday | DaysAllowed.Tuesday | DaysAllowed.Wednesday | DaysAllowed.Thursday | DaysAllowed.Friday
					},
					new RefDataType
					{
						Name = "Night Rate", Id = 2,
						EntryStartHours = 18, EntryStartMinutes = 0, EntryEndHours = 0,  EntryEndMinutes = 0,
					...
					new RefDataType
					{
						...
						DaysAllowed = DaysAllowed.Saturday | DaysAllowed.Sunday
					},
					new RefDataType
					{
